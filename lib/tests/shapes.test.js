...
describe('Shape', () => {
    //Ensures the fill property is set to the correct value
...
describe('Square', () => {
    ...
    describe('setColor', () => {
        it('should set the fill value of triangle to a new color', () => {
            ...
            let result = `<rect x="0" y="0" width="300" height="200" fill="blue"/>`
...
describe('Circle', () => {
    ...
    describe('setColor', () => {
        it('should set the fill value of triangle to a new color', () => {
            let circle = new Circle("white");
            circle.setColor("blue")
            let result = `<circle cx="150" cy="100" r="80" fill="blue"/>`
